    ...
    chrome.scripting.executeScript({
      ...
      function: () => {
        ...
        function changeEmailColors() {
          ...
          const containsAcceptanceKeywords = acceptanceKeywords.some(
            (keyword) => content.includes(keyword.toLowerCase())
          );
          const containsRejectionKeywords = rejectionKeywords.some((keyword) =>
            content.includes(keyword.toLowerCase())
          );

          if (containsAcceptanceKeywords) {
            chrome.runtime.sendMessage({
              message: "that's why you are the GOAT!!",
            });
            ...
            chrome.runtime.sendMessage({
              message: 'nah!, you thought you were good! huh',
            });
